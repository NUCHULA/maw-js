(async ()=>{
    ...
    class R {
        ...
        measure(t, e, s) {
            ...
            const n = performance.now(), r = `${t}|${e}`, a = ()=>{
                ...
                return i || (i = new T, this.collectors.set(r, i)), i;
            };
            try {
                const i = s();
    ...
    const U = "https://storage.googleapis.com/mediapipe-models/gesture_recognizer/gesture_recognizer/float16/latest/gesture_recognizer.task";
    class W extends N {
        async initTask(t, e) {
            const { GestureRecognizer: s } = await import("./chunks/DLVIciDT.js"), n = e;
        ...
        detectFrame(t, e, s) {
            return t.recognizeForVideo(e, s);
        }
        formatResult(t, e) {
            return {
                gestures: t.gestures.map((s, n)=>({
                        gesture: s[0]?.categoryName ?? "None",
                        score: s[0]?.score ?? 0,
                        handedness: t.handednesses[n]?.[0]?.categoryName ?? "Right",
